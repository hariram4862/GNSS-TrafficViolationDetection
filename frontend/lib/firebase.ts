...
import { getFirestore, doc, getDoc,addDoc, collection, getDocs, query, where } from "firebase/firestore";
...
export { db,  doc, getDoc, addDoc,collection, getDocs, query, where};